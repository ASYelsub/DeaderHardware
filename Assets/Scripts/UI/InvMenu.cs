...
public class InvMenu : MonoBehaviour
{
    ...
    public class ItemTag
    {
        ...
        public void AssignItem(int ID, GameManager gm)
        {
           
//            this.tagItem = ServicesLocator.ItemLibrary.ItemList[ID];
            this.isEmpty = false;
            this.tagText.text = gm.il.ItemList[ID].name;
            this.tagDesc = "yes";
        }
    ...
    {  
        itemTags[itemCounter].AssignItem(ID, gm);
        itemCounter++;
    }
